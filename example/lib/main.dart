            ...
            onPressed: () {
              EAnalytics.Eulerian.track([
                EAnalytics.EAProperty(path: '/home')
                  ...
                  // EAProperty custom params
                  ..addParam('customParam1', 'value')
                  ..addParam('customParam2', 3)
                  // custom site centric property params
                  ..setProperty(EAnalytics.SiteCentric()
                    ..addParam('key1', ['value'])
                    ..addParam('key2', ['value1', 'value2']))
                  // custom site centric cflag params
                  ..setCFlag(EAnalytics.SiteCentric()
                    ..addParam('custom', ['value'])
                    ..addParam('custom', ['value'])),
              ]);

              EAnalytics.Eulerian.track([
                // EASearch custom params
                EAnalytics.EASearch(
                    path: '/home',
                    search: EAnalytics.Search(name: 'name')
                      ..setParams(EAnalytics.Params()
                        ..addParam('key0', 'value0')
